...
elif "BARK_PUSH" in os.environ and os.environ["BARK_PUSH"]:
    BARK = os.environ["BARK_PUSH"]
if "BARK_HOST" in os.environ and os.environ["BARK_HOST"]:
...
def bark(title, content):
    ...
    try:
        if BARK_HOST:
            url = f"{BARK_HOST}/{BARK}/{title}/{urllib.parse.quote_plus(content)}"
        else:
            url = f"https://api.day.app/{BARK}/{title}/{urllib.parse.quote_plus(content)}"
