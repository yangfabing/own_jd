...
# 宠汪汪积分兑换京豆-新版
0 0,8,16 * * * python3 /scripts/jd_joy_reward_new.py >> /scripts/logs/jd_joy_reward_new.log 2>&1
...
# 赚京豆(微信小程序)
12 0 * * * node /scripts/jd_syj.js >> /scripts/logs/jd_syj.log 2>&1
# 京东快递签到
...
#电竞经理
12 0-23/2 * * * node /scripts/jd_EsportsManager.js >> /scripts/logs/jd_EsportsManager.log 2>&1
#半点红包雨
