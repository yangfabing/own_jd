...
# 赚京豆(微信小程序)
12 23 * * * node /scripts/jd_syj.js >> /scripts/logs/jd_syj.log 2>&1
# 京东快递签到
...
#电竞经理
12 0-23/2 * * * node /scripts/jd_djjl.js >> /scripts/logs/jd_djjl.log 2>&1
#半点红包雨
...
#京东试用
15 2 * * * node /scripts/jd_try.js >> /scripts/logs/jd_try.log 2>&1
